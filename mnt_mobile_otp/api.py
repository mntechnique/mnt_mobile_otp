# MN Technique and Contributors. see license.txt
import frappe, json
import random
...
def get_otp(mobile_no=None):
	...
	otp_length = cint(frappe.db.get_value("MNT OTP Settings", None, "otp_length"))
	otp_type = frappe.db.get_value("MNT OTP Settings", None, "otp_type")
